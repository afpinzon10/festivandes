...
public class AdminServices {
	...
	public Response initApp() {
		try {
			JMSFunciones manager = JMSFunciones.darInstacia(new FestivAndes(getPath()));
	...
	public void initDataFromFile(JMSFunciones manager) {
		try {
			...
			String connectionDataPath = contextPathP + FestivAndes.CONNECTION_DATA_FILE_NAME_REMOTE;
			...
			String topicAllUsuarios = prop.getProperty("topicAllFunciones");
