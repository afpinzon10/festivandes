 ...
 */
public class JMSAbonos implements MessageListener, ExceptionListener
{

	/**
	 * Atributo tipo JMSManager para manejar la única instancia del patron singleton
	 */
	private static JMSAbonos instancia;
	 ...
	 */
	public static JMSAbonos darInstacia(FestivAndes festivAndesMaster){
		instancia = instancia == null? new JMSAbonos() : instancia;
